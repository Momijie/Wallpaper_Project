...
hidden if the `Wallpaper_Project_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `Wallpaper_Project_DEVELOPER_MODE` to the configure
...
Runs the executable target `Wallpaper_Project_exe`.
